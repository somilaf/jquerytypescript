import logo = require('./logo/logo');
import httprx = require('./httprq');
import adminoption = require('./htmlcomponents/adminoption');
import newlogoform = require('./logo/newlogo');
import modifylogoform = require('./logo/modifylogo');
import newpage = require('./page/newpage');
import newlink = require('./link/newlink');
